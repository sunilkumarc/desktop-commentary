...
sudo chmod +x remove.sh commentary.py script.sh error.sh stop.sh icon.jpg
sudo mkdir /opt/desktop-commentary
sudo cp remove.sh commentary.py gui.py script.sh error.sh stop.sh icon.jpg /opt/desktop-commentary
